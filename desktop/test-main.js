...
(async () => {
  ...
  check('python engine resolved', fs.existsSync(sp.python) && fs.existsSync(path.join(sp.python, 'main.py')));
  ...
  check('python engine copied home', fs.existsSync(path.join(os.homedir(), '.gitwhisper', 'python', 'main.py')));
